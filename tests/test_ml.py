...
def _feature_row(
    ...
    *,
    ...
    cohort_count: int = 0,
    cohort_max_size: int = 0,
    cohort_max_cascade_count: int = 0,
    role_retail_user: int = 0,
    role_amplifier_suspect: int = 0,
    role_media_business: int = 0,
    role_journalist_public_figure: int = 0,
    role_source_hub: int = 0,
    first_retweeter_ratio: float = 0.0,
    propagation_lead_count: int = 0,
    ...
    return FeatureRow(
        ...
        role_retail_user=role_retail_user,
        role_amplifier_suspect=role_amplifier_suspect,
        role_media_business=role_media_business,
        role_journalist_public_figure=role_journalist_public_figure,
        role_source_hub=role_source_hub,
        first_retweeter_ratio=first_retweeter_ratio,
